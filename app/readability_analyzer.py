...
class ReadabilityAnalyzer:
    ...
    def count_syllables(self, word: str) -> int:
        ...
        if self.pronunciation_dict and clean_word in self.pronunciation_dict:
            ...
            syllable_count = len(
                [phone for phone in pronunciation if phone[-1].isdigit()]
            )
    ...
    def analyze_story_pages(
        ...
        logger.info(
            f"Analyzing story with {len(pages)} pages, {len(full_text)} characters"
        )
